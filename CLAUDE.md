...
The repo root is the Laravel project. Alongside it: five French-language product documents at v2.6 in `docs/dossier/`, dated Remento screenshots in `docs/reference/` (git-ignored), and the execution roadmap in `docs/roadmap/`.
...
- **Version discipline**: all five docs share one version (`v2.6 — Septembre 2026`). A substantive change bumps the version everywhere and adds a "Changements vX.Y" sentence under the title of doc 01.
