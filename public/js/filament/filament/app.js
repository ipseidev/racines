(() => {
    var te = Object.create,
        ...
        ue = oe((t, n) => {
            (function (a, s, m) {
                ...
                function w(e) {
                    var r = this;
                    if (((e = e || s), !(r instanceof w))) return new w(e);
    ...
    (function (t) {
        if (t) {
            ...
            ((t.prototype.stopCallback = function (s, m, c, y) {
                var h = this;
                return h.paused ? !0 : n[c] || n[y] ? !1 : a.call(h, s, m, c);
            }),
                (t.prototype.bindGlobal = function (s, m, c) {
                    var y = this;
                    if ((y.bind(s, m, c), s instanceof Array)) {
                        for (var h = 0; h < s.length; h++) n[s[h]] = !0;
                        return;
                    }
                    n[s] = !0;
                }),
            ...
            t.directive(
                ...
                (
                    ...
                    ((a = a.map((h) =>
                        ...
                        a.includes('global') &&
                            ((a = a.filter((h) => h !== 'global')),
                            K.default.bindGlobal(a, (h) => {
                                let g = R();
                                (g && !g.contains(n)) ||
                                    (h.preventDefault(), y());
                            })),
        ...
        setUpResizeObserver() {
            ...
            ((this.resizeObserver = new ResizeObserver(() => {
                ...
                (a && s
                    ...
                    : !a && m && (this.isOpen = this.isOpenDesktop),
                    (t = n));
            })),
    ...
    window.setUpSpaModeUnsavedDataChangesAlert = ({
        ...
        (document.addEventListener('livewire:navigate', (c) => {
            ...
            window.addEventListener('beforeunload', (c) => {
                s() && (c.preventDefault(), (c.returnValue = !0));
            }));
    };
