...
return [
    ...
    */
    ...
    'nav' => [
        ...
        'untitled_project' => 'Projet sans narrateur',
        'project_of' => 'Projet de :name',
        'dashboard' => 'Le projet',
    ...
    'dashboard' => [
        ...
        'gauge_title' => 'Où en est le livre',
        'gauge_open' => 'Voir le livre',
        'counts_asked' => ':count question posée|:count questions posées',
        'counts_asked_of' => ':count question posée sur :total|:count questions posées sur :total',
        'counts_recorded' => ':count racontée|:count racontées',
        'counts_shared' => ':count partagée|:count partagées',
        'counts_none' => 'Rien n’est encore parti.',
        'until' => 'Questions jusqu’au :date',
        'today' => 'Aujourd’hui',
        'upcoming' => 'Ce qui vient',
        'upcoming_none' => 'Plus rien n’attend d’être posé.',
        'upcoming_all' => 'Voir et réordonner les questions',
        'yours' => 'Votre question',
        'asked_by' => 'Question de :name',
    ...
    'questions' => [
        ...
        'removed' => 'Votre question est retirée.',
        'remove' => 'Retirer ma question',
        'updated' => 'C’est enregistré.',
        'added' => 'Votre question est ajoutée.',
        'added_without_photo' => 'Votre question est ajoutée, mais une photo n’a pas pu être jointe.',
        'title' => 'Les questions posées à :name',
        'title_generic' => 'Les questions',
        'intro' => 'Dans cet ordre, une par envoi. Montez ce qui vous tient à cœur, écartez ce qui ne convient pas : c’est enregistré aussitôt. :name garde toujours le droit de ne pas répondre.',
        'asked' => 'Déjà posée',
        'excluded' => 'Écartée',
        'exclude' => 'Écarter',
        'restore' => 'Remettre',
        ...
        'search_all' => 'Chercher parmi les :count questions',
        'later' => 'plus tard',
        'sends_on' => 'part le :date',
        'list_title' => 'L’ordre des envois',
        'corpus_title' => 'Le corpus',
        'corpus_intro' => 'Les :count questions disponibles. Cherchez, filtrez par thème, et posez bientôt celles qui comptent.',
        'search' => 'Chercher une question',
        'search_placeholder' => 'un mot : école, guerre, cuisine…',
        'theme_all' => 'Tous les thèmes',
        'soon' => 'Poser bientôt',
        'no_match' => 'Aucune question ne correspond. Essayez un autre mot, ou posez la vôtre.',
        'next_title' => 'Les prochaines',
        'next_intro' => 'Dans cet ordre, une par envoi. Glissez pour réordonner, ou servez-vous des flèches.',
        'next_rest' => 'et :count autres dans le corpus',
        'pending_badge' => 'Votre question',
        'pending_hint' => 'Elle partira au prochain envoi, avant celles du corpus.',
        'pending_photos' => ':count photo|:count photos',
        'tab_next' => 'Les prochaines',
        'tab_corpus' => 'Le corpus',
        'drag' => 'Déplacer',
        ...
        'add' => [
            ...
            'photos_hint' => 'Facultatif, quatre au plus. :name les verra avec la question — « raconte-nous celle-ci ».',
            'photos_remove' => 'Retirer cette photo',
            'photos_too_many' => 'Quatre photos au plus par question.',
        ],
    ],
    ...
    'family' => [
        ...
        'invite' => [
            ...
            'can_ask' => 'L’autoriser à poser ses propres questions',
            'can_ask_help' => 'Elle pourra demander ce qu’elle aimerait savoir, avec ses photos. Sa question partira après celles qui attendent déjà, et vous pourrez la retirer.',
    ...
    'settings' => [
        ...
        'locale_help' => 'La langue des pages que verront :name et vos proches. Elle ne change pas la vôtre.',
        'locale_saved' => 'La langue du projet est enregistrée.',
    ...
    'personalize' => [
        ...
        'continue' => 'Continuer',
        'welcome' => [
            'eyebrow' => 'Deux minutes, pas plus',
            'title' => 'Et si ses questions lui ressemblaient vraiment ?',
            'body' => 'Deux minutes pour nous parler de :name. Nous choisirons ses questions en fonction de sa vie, et vous pourrez tout changer ensuite.',
            'start' => 'Commencer',
            'skip_all' => 'Passer, choisissez pour moi',
        ],
        'relation' => [
            'eyebrow' => ':n · Votre lien',
            'title' => 'Qui est :name pour vous ?',
            'body' => 'Nous saurons comment lui parler, et quelles questions vous concernent.',
            'mother' => 'Ma mère',
            'father' => 'Mon père',
            'grandmother' => 'Ma grand-mère',
            'grandfather' => 'Mon grand-père',
            'partner' => 'Ma compagne, mon compagnon',
            'other' => 'Un autre proche',
            'gender_label' => 'Ses questions lui parleront…',
            'feminine' => 'Au féminin',
            'masculine' => 'Au masculin',
        ],
        'about' => [
            'eyebrow' => ':n · Et vous ?',
            'title' => 'Des questions sur vous aussi ?',
            'body' => 'Quelques questions, espacées dans l’année, où :name parle de vous. Jamais la première.',
            'buyer' => 'Oui, quelques-unes sur moi',
            'everyone' => 'Plutôt sur tous ses enfants',
            'none' => 'Non, merci',
            'name_label_feminine' => 'Le prénom qu’elle vous donne',
            'name_label_masculine' => 'Le prénom qu’il vous donne',
            'placeholder' => 'Claire',
            'child_feminine' => 'Sa fille',
            'child_masculine' => 'Son fils',
            'grandchild_feminine' => 'Sa petite-fille',
            'grandchild_masculine' => 'Son petit-fils',
            'other_feminine' => 'Au féminin',
            'other_masculine' => 'Au masculin',
            'preview' => 'Par exemple, vers la sixième semaine',
        ],
        'life' => [
            'eyebrow' => ':n · Sa vie',
            'title' => 'Un peu de sa vie',
            'body_feminine' => 'Un « non » retire les questions qui ne la concernent pas. Dans le doute, ne répondez pas : rien n’est retiré.',
            'body_masculine' => 'Un « non » retire les questions qui ne le concernent pas. Dans le doute, ne répondez pas : rien n’est retiré.',
            'yes' => 'Oui',
            'no' => 'Non',
            'facts' => [
                'partner' => 'A vécu en couple',
                'children' => 'A eu des enfants',
                'grandchildren' => 'A des petits-enfants',
                'career' => 'A exercé un métier',
                'siblings' => 'A des frères et sœurs',
                'migration_feminine' => 'A grandi loin d’où elle vit',
                'migration_masculine' => 'A grandi loin d’où il vit',
                'rural' => 'A grandi à la campagne',
            ],
        ],
        'avoid' => [
            'eyebrow' => ':n · Avec délicatesse',
            'title' => 'Des sujets à laisser de côté ?',
            'body' => 'Nous ne poserons aucune question qui y touche. Rien n’est coché d’avance.',
            'hint' => ':name pourra toujours passer une question, sans avoir à dire pourquoi.',
            'none' => 'Aucun, continuer',
        ],
        'themes' => [
            'eyebrow' => ':n · Ce qui vous tient à cœur',
            'title' => 'Qu’aimeriez-vous l’entendre raconter ?',
            'body' => 'Jusqu’à trois thèmes, qui passeront en premier. Les autres suivront : un livre a besoin de tout.',
            'count' => ':count sur 3',
            'count_none' => 'Aucun thème choisi : nous équilibrerons',
            'cta' => 'Voir ses premières questions',
            'lines' => [
                'childhood' => 'La maison, l’école, les bêtises',
                'family_origins' => 'Les grands-parents, les traditions',
                'youth' => 'Les bals, la musique, la liberté',
                'work' => 'Les collègues, le premier salaire',
                'love' => 'La rencontre, la vie à deux',
                'places' => 'Le village, la maison quittée',
                'joys' => 'Les passions, les fous rires',
                'hardships' => 'Ce qui a été dur, et ce qui a aidé',
                'beliefs_values' => 'Ce que la vie lui a appris',
                'legacy' => 'Les recettes, les gestes, les messages',
            ],
        ],
        'first' => [
            'eyebrow' => 'Voilà par où commencer',
            'title' => 'Choisissez sa toute première question',
            'badge' => 'Première',
            'later' => 'Et vers la sixième semaine :',
            'cta' => 'C’est parti',
            'empty' => 'Aucune question à proposer pour l’instant : nous choisirons pour vous.',
        ],
        'done' => [
            'title' => 'C’est prêt',
            'body' => 'Ses questions suivront ce que vous nous avez dit de :name. Vous pourrez tout ajuster depuis votre espace.',
            'skipped_title' => 'Nous nous en occupons',
            'skipped_body' => 'Nous choisirons ses questions avec soin. Vous pourrez les personnaliser à tout moment depuis votre espace.',
            'cta' => 'Aller à mon espace',
            'redo' => 'Revoir le parcours',
        ],
        'errors' => [
            'first' => 'Cette question ne fait plus partie des premières. Choisissez-en une autre.',
            'facts' => 'Une réponse sur sa vie n’est pas reconnue.',
        ],
        'banner' => [
            'title' => 'Et si ses questions lui ressemblaient ?',
            'body' => 'Deux minutes pour nous parler de :name : nous choisirons ses questions en fonction de sa vie.',
            'cta' => 'Personnaliser ses questions',
        ],
        'questions_link' => 'Personnaliser selon sa vie',
    ],
];
