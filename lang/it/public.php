...
return [
    ...
    */
    'seo' => [
        ...
        'quiz' => [
            'title' => 'Da dove cominciare: due minuti di domande',
            'description' => 'Dieci domande per capire se il libro fa al caso della persona a cui tieni, e uscirne con il piano delle prime settimane: il messaggio che riceverà e le sue prime domande.',
        ],
        'checkout' => [
    ...
    */
    'lp' => [
        ...
        'cta' => [
            'buy' => 'Regalo questo libro',
            'buy_price' => 'Regalo questo libro · :price',
        ...
        'hero' => [
            'title' => 'Il libro dei suoi ricordi, con la sua voce a ogni capitolo.',
            'lede' => 'Alla persona cara basta raccontare. :brand ascolta, mette per iscritto il suo racconto e ne fa un libro rilegato in cui ogni pagina porta le sue parole e ogni capitolo riproduce la sua voce. Niente da scrivere, niente da installare: le sue storie, in un libro che si tramanda.',
            'checks' => [
                'no_app' => 'La persona cara risponde dal suo telefono: nessuna app, nessun account da creare.',
                'choice' => 'Parlare, filmarsi o scrivere: la scelta è sua, a ogni domanda.',
                'rhythm' => 'Una domanda a settimana, al suo ritmo, configurabile.',
                'refund' => 'Se la persona cara non vuole partecipare, ti rimborsiamo tutto.',
            ],
        ...
        'benefits' => [
            ...
            'quiz' => 'Da dove cominciare',
            'discover' => [
                'title' => 'Scoprire quello che non si è mai chiesto',
                'body' => 'I primi amori, le partenze, le piccole cose che non si raccontano se nessuno le chiede. Basta una domanda per farle riaffiorare.',
            ],
            'voice' => [
                'title' => 'Ritrovare il suo modo di raccontare',
                'body' => 'Il libro conserva il racconto. La registrazione ne restituisce la voce, i silenzi e le risate.',
            ],
            'share' => [
                'title' => 'Darle qualcuno che ascolta',
                'body' => 'Il libro è ciò che resta. Quello che succede prima è che qualcuno le pone una domanda, e ascolta la risposta fino in fondo.',
            ],
        ...
        'what' => [
            ...
            'title' => 'Un libro sulla vita della persona cara, raccontata con la sua voce.',
            'body' => 'Una domanda dopo l’altra, i ricordi della persona cara diventano i capitoli di un libro. :brand mette per iscritto le sue risposte senza riscriverle: le sue parole restano le sue. Ogni capitolo porta un codice da scansionare che riproduce la registrazione originale. Si legge la sua storia, e la si sente raccontare.',
        ],
        ...
        'how' => [
            ...
            'one' => [
                ...
                'card_label' => 'Domanda del giorno',
                'card_question' => 'Quale odore la riporta alla sua infanzia?',
                'body' => 'Più di novanta domande, scritte per far riaffiorare un ricordo preciso invece di un riassunto di vita. Tieni quelle che le somigliano, scarta le altre, aggiungi le tue.',
            ],
            'two' => [
                'title' => "Arriva una domanda.\nBasta rispondere.",
                'body' => 'Il link arriva per SMS o per e-mail, nel giorno e nel momento scelti. Niente da installare, nessun account da creare: la persona cara tocca il link e risponde, parlando, filmandosi o scrivendo.',
            ],
            'three' => [
                'title' => "Le sue parole diventano\nun capitolo.",
                'body' => 'Trascriviamo la registrazione, poi la mettiamo in bella copia: le esitazioni in meno, le sue espressioni intatte. La parola per parola resta accanto, e niente parte prima della sua rilettura.',
            ],
            'four' => [
                'title' => "La persona cara decide.\nLa famiglia scopre.",
                'body' => 'Niente è visibile prima della sua decisione: né per la famiglia, né per te. Una volta condivisa la storia, ognuno può leggerla, ascoltarla e risponderle. Per molte famiglie diventa il momento più bello della settimana.',
            ],
            'more' => 'Scopri il percorso nel dettaglio',
        ],
        ...
        'offer' => [
            ...
            'stars' => 'Cinque stelle su cinque',
            'title' => 'Il libro di una vita che si può ascoltare',
            'lede' => 'Tutto quello che non abbiamo mai pensato di chiedere, e che non ha mai pensato di raccontare.',
            'gallery' => [
            ...
            'read' => [
                'title' => 'Le sue parole, non le nostre.',
                'body' => 'Ogni capitolo è una storia raccontata dalla tua persona cara, messa in bella copia da :brand, senza essere riscritta.',
            ],
            'hear' => [
                'title' => 'La sua voce, a ogni capitolo.',
                'body' => 'Un codice da scansionare a ogni capitolo riproduce la registrazione originale. La sua voce, così come l’ha detta.',
            ],
            'bound' => [
                'title' => 'Fatto per durare.',
                'body' => 'Copertina rigida, tutto a colori, formato 16 × 24 cm. Stampa professionale su carta a doppio spessore.',
            ],
            'includes' => [
                'questions' => 'Una domanda a settimana, al suo ritmo',
                'book' => 'Un libro rilegato a colori, con le sue foto',
                'text' => 'Le sue risposte trascritte e messe in bella copia',
                'qr' => 'Un codice da scansionare per ogni capitolo',
                'shipping' => 'La consegna in Francia',
                'family' => 'La famiglia invitata ad ascoltare e a reagire',
            ],
            'buy' => 'Acquista • :price',
            'guarantees' => [
                'refund' => 'Garanzia soddisfatti o rimborsati entro 30 giorni',
                'yours' => 'Le tue registrazioni e i tuoi testi restano tuoi',
                'download' => 'Scaricabili in qualsiasi momento',
            ],
            'player' => [
                'label' => 'Ascolta ora',
         ...
         */
        'access' => [
            'title' => 'Tieni tutto. Per sempre.',
            'lede' => ':brand comprende le domande, il libro rilegato e l’accesso online a tutto quello che la persona cara ha registrato. Le registrazioni originali e i testi si scaricano quando vuoi, in formati che qualsiasi dispositivo sa leggere.',
            ...
            'download' => [
                'title' => 'Tutto si scarica',
                'body' => 'Le registrazioni originali, i testi e il libro in PDF. Li conservi dove vuoi, sul computer o su una chiavetta.',
            ],
            'renew' => [
                'title' => 'Non è un abbonamento',
                'badge' => 'Facoltativo',
                'body' => 'Paghi una volta sola. Niente si rinnova, niente viene addebitato alla fine dell’anno. Se vuoi ripartire per un altro ciclo, riacquisti, e solo se lo decidi tu.',
            ],
            'banner' => 'Le tue registrazioni restano tue. Dopo un anno, rinnovi solo se vuoi continuare a raccontare.',
            'buy' => 'Comincio il suo libro',
            'checks' => [
                'refund' => 'Garanzia soddisfatti o rimborsati entro 30 giorni',
         ...
         */
        'easy' => [
            'title' => 'Pensato per i genitori. Approvato dalla famiglia.',
            'lede' => 'Per chi racconta, dai 9 ai 99 anni.',
            'marks' => [
                'no_writing' => 'Niente da scrivere.',
                'no_app' => 'Niente da installare.',
                'no_password' => 'Niente da ricordare.',
            ],
            'cta' => 'Prova: ci vogliono 60 secondi',
    ...
    */
    'faq_page' => [
        ...
        'common' => [
            ...
            'printed' => [
                ...
                'a' => ':brand trasforma la trascrizione delle registrazioni in testo scritto, secondo la tua preferenza: o la trascrizione messa in bella copia, o un racconto scorrevole, redatto a partire da ciò che ha detto.',
            ],
            'shipping' => [
            ...
            'language' => [
                ...
                'a' => 'La messa in bella copia supporta il francese. Altre lingue seguiranno.',
            ],
            'seniors' => [
        ...
        'recording' => [
            'submit' => [
                ...
                'a' => 'È semplice: basta toccare il link ricevuto per e-mail o per messaggio. Nessuna app da scaricare, nessuna password. Va bene qualsiasi dispositivo connesso, e :brand si occupa del resto.',
            ],
            'writing' => [
            ...
            'languages' => [
                ...
                'a' => ':brand supporta il francese. Le registrazioni sono trascritte fedelmente, stampate nel libro rilegato, e il codice QR di ogni capitolo riproduce la registrazione originale.',
            ],
        ],
        ...
        'book' => [
            ...
            'printed' => [
                ...
                'a' => 'Scegli tu, per ogni storia, tra la parola per parola e il racconto messo in bella copia.',
            ],
            'edit' => [
        ...
        'other' => [
            'storyworth' => [
                ...
                'a' => ':brand cattura la voce e la personalità attraverso ricordi registrati, mentre Storyworth raccoglie risposte scritte. :brand trasforma le registrazioni in storie scritte, e un codice QR riproduce la voce accanto al testo stampato.',
            ],
            'my_life' => [
    ...
    'welcome_offer' => [
        ...
        'subtitle' => 'sul suo prossimo ordine',
        ...
        'news' => 'Voglio essere al corrente delle prossime promozioni.',
        'send' => 'Ricevi il mio codice',
        'waiting' => 'Un attimo…',
        'fine_print' => 'Il tuo indirizzo serve a inviarti il codice, e a nient’altro se togli la spunta dalla casella. In ogni messaggio c’è un link per smettere.',
        'sent_title' => 'Inviato',
    ...
    */
    ...
    'quiz' => [
        ...
        'relationship' => [
            'title' => 'Di chi vorresti conservare la storia?',
            'lede' => 'Dieci domande, due minuti. Niente da installare, e nessun indirizzo richiesto prima della fine.',
            'self_note' => 'Vuoi raccontare la tua storia? Il percorso è un po’ diverso: ti ci portiamo subito.',
        ],

        'voice' => [
            'title' => 'La voce conta quanto le parole',
            'body' => 'Fra dieci anni, quello che i tuoi figli vorranno riascoltare non sarà solo la storia: sarà il modo in cui :subject la racconta. Il modo di ridere a metà frase. Le espressioni che esistono solo nella vostra famiglia.',
            'listen' => 'Venti secondi di una registrazione vera, fatta con un telefono qualunque.',
        ],

        'age' => [
            'title' => 'Quanti anni ha :subject?',
            'hint' => 'Non si chiedono le stesse cose a chi è nato nel 1935 e a chi è nato nel 1955. Serve a questo.',
        ],

        'distance' => [
            'title' => 'Quanto siete lontani l’uno dall’altra?',
        ],

        'closeness' => [
            'far_title' => 'Si riattacca sempre prima di aver fatto la domanda',
            'far_body' => 'Ci si dice che ci sarà tempo la prossima volta, e la prossima volta si parla del tempo e dei nipoti. Una domanda a settimana è un appuntamento che non dipende più da chi chiama chi.',
            'near_title' => 'Si crede di avere tempo perché ci si vede',
            'near_body' => 'È proprio quando ci si vede spesso che non si chiede mai niente: le domande grandi sembrano troppo solenni in mezzo a un pranzo della domenica. Per iscritto, una domanda si risponde senza cerimonie, la sera, quando viene voglia.',
        ],

        'themes' => [
            'title' => 'Di cosa vorresti che :subject parlasse?',
            'hint' => 'Almeno tre. Potrai cambiare tutto dopo, e aggiungerne strada facendo.',
            'remaining' => 'Ancora un tema|Ancora :count temi',
            'chosen' => ':count tema scelto|:count temi scelti',
        ],

        'storyteller' => [
            'title' => 'Quando :subject racconta, è piuttosto…',
        ],

        'nothing' => [
            'title' => '« Non c’è niente da raccontare » è la frase più comune',
            'body' => 'È quasi sempre falsa, e quasi sempre per lo stesso motivo: nessuno ha fatto la domanda giusta. « Raccontami la tua vita » non dà niente. « Che odore aveva la casa della tua infanzia? » dà venti minuti.',
            'body_2' => 'Le nostre sessanta domande sono scritte per questo. Sono precise, cominciano dalle più facili, e diventano intime solo quando l’abitudine è presa.',
        ],

        'tech' => [
            'title' => ':subject se la cava con il telefono?',
            'hint' => 'Rispondi con franchezza: è questa risposta a decidere cosa ti proporremo dopo.',
        ],

        'install' => [
            'title' => 'Non c’è niente da installare',
            'body' => 'Nessuna app, nessun account, nessuna password. :subject riceve un messaggio con un link, lo tocca, tocca un pulsante grande e parla. Se la registrazione si interrompe — una telefonata, un campanello — riprende da dove era rimasta. E se un giorno scrivere è più semplice che parlare, la pagina lo permette lo stesso.',
            'help_title' => 'Allora è meglio saperlo adesso',
            'help_body' => 'Tutto si regge su un link aperto da un telefono: se quel gesto non è acquisito, meglio parlarne prima di comprare che dopo. Due cose lo rendono comunque possibile. Qualcuno della famiglia apre il link e resta accanto per la prima registrazione — dopo, il gesto è preso. Oppure chiamiamo noi, ogni settimana, all’ora concordata: questa opzione è a pagamento e i posti sono limitati; te la proporremo all’ordine se sarà ancora aperta.',
        ],

        'channel' => [
            'title' => 'Come si raggiunge :subject con più sicurezza?',
            'hint' => 'È da lì che partiranno l’invito e poi una domanda a settimana.',
        ],

        'name' => [
            'title' => 'Come si chiama :subject?',
            'first_name' => 'Il suo nome',
            'first_name_placeholder' => 'Giovanna',
            'nickname' => 'E tu, come la chiami?',
            'nickname_placeholder' => 'Nonna',
            'nickname_hint' => 'Mamma, nonna, o semplicemente il suo nome. È quella parola che finirà nel messaggio — non la nostra.',
        ],

        'cover' => [
            'title' => 'Ecco il libro di :name',
            'hint' => 'Scegli il titolo e la copertina. Potrai ancora cambiarli prima della stampa.',
            'titles' => 'Titoli possibili',
            'custom' => 'Il tuo titolo',
            'custom_placeholder' => 'Le domeniche da Giovanna',
            'custom_hint' => 'Ottanta caratteri al massimo: oltre, la riga esce troppo piccola per leggersi sul dorso.',
            'swatches' => 'Tinte della copertina',
            'note' => 'Copertina rigida, stampa a colori, un QR per capitolo per riascoltare la sua voce.',
        ],

        'occasion' => [
            'title' => 'È per un’occasione?',
            'date' => 'Che giorno deve partire l’invito?',
            'date_hint' => 'Data e ora restano modificabili fino al pagamento.',
        ],

        'preview' => [
            'eyebrow' => 'Il tuo piano',
            'title' => 'Ecco cosa riceverà :name',
            'when' => 'Il :date alle :time, via :channel.',
            'from' => 'Da: :sender',

            'book_label' => 'Alla fine, questo',
            'book_note' => 'Copertina :cover, un capitolo per storia, un QR che rimette la sua voce.',

            'invitation_label' => 'Prima, l’invito',
            // I messaggi partono in francese: questa è l'anteprima tradotta.
            'invitation' => ':name, :inviter ti invita a raccontare i tuoi ricordi con :brand: una domanda a settimana, e un libro alla fine. Vedere il regalo: :link Questo link non chiederà mai una password né un pagamento.',
            'inviter_placeholder' => '[il tuo nome]',
            'link_placeholder' => '[il tuo link]',
            'invitation_note' => 'È il messaggio vero, parola per parola. Manca solo il tuo nome. L’invito non chiede nulla: propone di scoprire.',

            'first_label' => 'Poi, appena :name avrà accettato, la sua prima domanda',
            'first_note' => 'Non è un esempio: è la domanda che il corpus sceglie per :name, in base ai temi che hai appena spuntato. Sempre una domanda facile per prima — una domanda intima, la prima settimana, fa riattaccare.',

            'next_label' => 'E le successive',
            'next_note' => 'Una a settimana, nei tuoi temi. Potrai riordinarle, toglierne, e scriverne di nuove.',

            'themes_label' => 'I tuoi temi',
            'empty' => 'Il corpus di domande non è ancora caricato su questo ambiente: il piano comparirà appena lo sarà.',

            'validation_note' => 'Nulla di ciò che :name registra è visibile prima che l’abbia riletto e approvato. La decisione è sua — non tua, e non nostra.',

            'cta' => 'Regala questo libro a :name',
            'restart' => 'Rifai il questionario',

            'email' => [
                'title' => 'Preferisci pensarci?',
                'body' => 'Lascia il tuo indirizzo: ti inviamo il codice di benvenuto. Il piano resta qui — questa pagina si riaprirà sulle tue risposte da questo dispositivo.',
                'label' => 'Il tuo indirizzo email',
                'submit' => 'Ricevi il mio codice',
                'news' => 'Voglio ricevere anche le vostre notizie',
                'news_hint' => 'Rare, e con un link per smettere in ogni messaggio. Questa casella non è mai obbligatoria.',
                'privacy' => 'Il tuo indirizzo serve a inviarti questo codice, e a nient’altro se la casella qui sopra resta vuota.',
                'saved' => 'Fatto. Il codice è nella tua casella — guarda anche nello spam.',
            ],
        ],
    ],
    ...
    'checkout' => [
        ...
        'gift' => [
            'intro' => 'Sei tu a decidere quando parte, e cosa dice.',
            'intro_self' => 'Sei tu a decidere quando arriva la tua prima domanda.',
            'when' => 'Quando inviare l’invito?',
            'when_now' => 'Subito, con l’ordine',
            'when_now_hint' => 'L’invito parte entro un minuto. Comodo per avvisare a voce subito dopo.',
            'when_date' => 'A una data che scelgo io',
            'when_date_hint' => 'Fino a tre mesi dopo, all’ora che vuoi.',
            'when_now_self' => 'Subito',
            'when_now_hint_self' => 'La tua prima domanda arriva subito dopo.',
            'send_at' => 'Che giorno?',
            'send_time' => 'A che ora?',
        ...
        'summary' => [
            ...
            'gift_line_now' => 'Subito, con l’ordine',
            'options' => 'Le opzioni',
        ...
        'thanks' => [
            ...
            'next' => [
                ...
                'invite_now' => 'L’invito parte entro un minuto, con il tuo messaggio.',
                'invite_now_self' => 'La tua prima domanda arriva subito dopo.',
            ...
            'now_title' => 'Due cose da fare finché c’è tempo',
            'now' => [
                'questions_title' => 'Scegliere le tue domande',
                'questions_body' => 'La prima partirà appena :name avrà accettato. Puoi decidere quale, scriverne una tu stesso e cambiare l’ordine quando vuoi.',
                'questions_body_soon' => 'La prima partirà appena l’invito sarà accettato. Puoi decidere quale, scriverne una tu stesso e cambiare l’ordine quando vuoi.',
                'questions_body_self' => 'Decidi tu da cosa cominciare, puoi scrivere le tue domande e cambiare l’ordine quando vuoi.',
                'questions_cta' => 'Vedere le domande',
                'family_title' => 'Invitare i tuoi cari',
                'family_body' => 'Ognuno riceve il proprio link di ascolto, mai un link comune. Scegli tu chi può, in più, fare le proprie domande.',
                'family_cta' => 'Invitare dei cari',
            ],
