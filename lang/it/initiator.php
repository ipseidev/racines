...
return [
    ...
    */
    ...
    'nav' => [
        ...
        'untitled_project' => 'Progetto senza narratore',
        'project_of' => 'Progetto di :name',
    ...
    'dashboard' => [
        ...
        'timeline' => 'Le storie',
        'gauge_title' => 'A che punto è il libro',
        'gauge_open' => 'Vedere il libro',
        'counts_asked' => ':count domanda posta|:count domande poste',
        'counts_asked_of' => ':count domanda posta su :total|:count domande poste su :total',
        'counts_recorded' => ':count raccontata|:count raccontate',
        'counts_shared' => ':count condivisa|:count condivise',
        'counts_none' => 'Non è ancora partito nulla.',
        'until' => 'Domande fino al :date',
        'today' => 'Oggi',
        'upcoming' => 'Ciò che viene',
        'upcoming_none' => 'Non c’è più nulla in attesa di essere posto.',
        'upcoming_all' => 'Vedere e riordinare le domande',
        'yours' => 'La sua domanda',
        'asked_by' => 'Domanda di :name',
    ...
    'questions' => [
        ...
        'removed' => 'La sua domanda è tolta.',
        'remove' => 'Togliere la mia domanda',
        'updated' => 'Salvato.',
        'added' => 'La tua domanda è stata aggiunta.',
        'added_without_photo' => 'La sua domanda è aggiunta, ma una foto non ha potuto essere allegata.',
        'title' => 'Le domande poste a :name',
        'title_generic' => 'Le domande',
        'intro' => 'In quest’ordine, una per invio. Alzi ciò che le sta a cuore, scarti ciò che non va: si salva subito. :name conserva sempre il diritto di non rispondere.',
        'asked' => 'Già posta',
        'excluded' => 'Scartata',
        'exclude' => 'Scarta',
        'restore' => 'Ripristina',
        ...
        'search_all' => 'Cercare tra le :count domande',
        'later' => 'più tardi',
        'sends_on' => 'parte il :date',
        'list_title' => 'L’ordine degli invii',
        'corpus_title' => 'Il corpus',
        'corpus_intro' => 'Le :count domande disponibili. Cerchi, filtri per tema, e metta presto quelle che contano.',
        'search' => 'Cercare una domanda',
        'search_placeholder' => 'una parola: scuola, guerra, cucina…',
        'theme_all' => 'Tutti i temi',
        'soon' => 'Porre presto',
        'no_match' => 'Nessuna domanda corrisponde. Provi un’altra parola, o ponga la sua.',
        'next_title' => 'Le prossime',
        'next_intro' => 'In quest’ordine, una per invio. Trascini per riordinare, o usi le frecce.',
        'next_rest' => 'e altre :count nel corpus',
        'pending_badge' => 'La sua domanda',
        'pending_hint' => 'Partirà al prossimo invio, prima di quelle del corpus.',
        'pending_photos' => ':count foto|:count foto',
        'tab_next' => 'Le prossime',
        'tab_corpus' => 'Il corpus',
        'drag' => 'Spostare',
        ...
        'add' => [
            ...
            'photos_hint' => 'Facoltativo, quattro al massimo. :name le vedrà con la domanda — « ci racconti questa ».',
            'photos_remove' => 'Togliere questa foto',
            'photos_too_many' => 'Quattro foto al massimo per domanda.',
        ],
    ],
    ...
    'family' => [
        ...
        'invite' => [
            ...
            'can_ask' => 'Autorizzarla a fare le proprie domande',
            'can_ask_help' => 'Potrà chiedere ciò che le piacerebbe sapere, con le sue foto. La sua domanda partirà dopo quelle già in attesa, e lei potrà toglierla.',
     ...
     */
    'personalize' => [
        'title' => 'Personalizzare le domande',
        'quit' => 'Esci',
        ...
        'continue' => 'Continua',
        'welcome' => [
            'eyebrow' => 'Due minuti, non di più',
            'title' => 'E se le sue domande le somigliassero davvero?',
            'body' => 'Due minuti per parlarci di :name. Sceglieremo le sue domande in base alla sua vita, e potrai cambiare tutto in seguito.',
            'start' => 'Inizia',
            'skip_all' => 'Salta, scegliete voi',
        ],
        'relation' => [
            'eyebrow' => ':n · Il vostro legame',
            'title' => 'Chi è :name per te?',
            'body' => 'Sapremo come parlarle, e quali domande ti riguardano.',
            'mother' => 'Mia madre',
            'father' => 'Mio padre',
            'grandmother' => 'Mia nonna',
            'grandfather' => 'Mio nonno',
            'partner' => 'La mia compagna, il mio compagno',
            'other' => 'Un’altra persona cara',
            'gender_label' => 'Le sue domande le parleranno…',
            'feminine' => 'Al femminile',
            'masculine' => 'Al maschile',
        ],
        'about' => [
            'eyebrow' => ':n · E tu?',
            'title' => 'Anche qualche domanda su di te?',
            'body' => 'Qualche domanda, distribuita nell’anno, in cui :name parla di te. Mai la prima.',
            'buyer' => 'Sì, qualcuna su di me',
            'everyone' => 'Piuttosto su tutti i suoi figli',
            'none' => 'No, grazie',
            'name_label_feminine' => 'Il nome con cui lei ti chiama',
            'name_label_masculine' => 'Il nome con cui lui ti chiama',
            'placeholder' => 'Chiara',
            'child_feminine' => 'Sua figlia',
            'child_masculine' => 'Suo figlio',
            'grandchild_feminine' => 'Sua nipote',
            'grandchild_masculine' => 'Suo nipote',
            'other_feminine' => 'Al femminile',
            'other_masculine' => 'Al maschile',
            'preview' => 'Per esempio, verso la sesta settimana',
        ],
        'life' => [
            'eyebrow' => ':n · La sua vita',
            'title' => 'Un po’ della sua vita',
            'body_feminine' => 'Un «no» toglie le domande che non la riguardano. Nel dubbio, non rispondere: non si toglie niente.',
            'body_masculine' => 'Un «no» toglie le domande che non lo riguardano. Nel dubbio, non rispondere: non si toglie niente.',
            'yes' => 'Sì',
            'no' => 'No',
            'facts' => [
                'partner' => 'Ha vissuto in coppia',
                'children' => 'Ha avuto figli',
                'grandchildren' => 'Ha dei nipoti',
                'career' => 'Ha svolto un lavoro',
                'siblings' => 'Ha fratelli o sorelle',
                'migration_feminine' => 'È cresciuta lontano da dove vive',
                'migration_masculine' => 'È cresciuto lontano da dove vive',
                'rural' => 'Ha passato l’infanzia in campagna',
            ],
        ],
        'avoid' => [
            'eyebrow' => ':n · Con delicatezza',
            'title' => 'Argomenti da lasciare da parte?',
            'body' => 'Non faremo nessuna domanda che li tocchi. Niente è selezionato in anticipo.',
            'hint' => ':name potrà sempre saltare una domanda, senza dover dire perché.',
            'none' => 'Nessuno, continua',
        ],
        'themes' => [
            'eyebrow' => ':n · Ciò che ti sta a cuore',
            'title' => 'Che cosa ti piacerebbe sentirle raccontare?',
            'body' => 'Fino a tre temi, che verranno per primi. Gli altri seguiranno: un libro ha bisogno di tutto.',
            'count' => ':count su 3',
            'count_none' => 'Nessun tema scelto: faremo noi l’equilibrio',
            'cta' => 'Vedi le sue prime domande',
            'lines' => [
                'childhood' => 'La casa, la scuola, le marachelle',
                'family_origins' => 'I nonni, le tradizioni',
                'youth' => 'I balli, la musica, la libertà',
                'work' => 'I colleghi, il primo stipendio',
                'love' => 'L’incontro, la vita a due',
                'places' => 'Il paese, la casa lasciata',
                'joys' => 'Le passioni, le risate',
                'hardships' => 'Ciò che è stato difficile, e ciò che ha aiutato',
                'beliefs_values' => 'Ciò che la vita le ha insegnato',
                'legacy' => 'Le ricette, i gesti, i messaggi',
            ],
        ],
        'first' => [
            'eyebrow' => 'Ecco da dove cominciare',
            'title' => 'Scegli la sua primissima domanda',
            'badge' => 'Prima',
            'later' => 'E verso la sesta settimana:',
            'cta' => 'Si parte',
            'empty' => 'Nessuna domanda da proporre per ora: sceglieremo noi.',
        ],
        'done' => [
            'title' => 'È pronto',
            'body' => 'Le sue domande seguiranno ciò che ci hai detto di :name. Potrai sistemare tutto dal tuo spazio.',
            'skipped_title' => 'Ci pensiamo noi',
            'skipped_body' => 'Sceglieremo le sue domande con cura. Potrai personalizzarle in qualsiasi momento dal tuo spazio.',
            'cta' => 'Vai al mio spazio',
            'redo' => 'Rivedi il percorso',
        ],
        'errors' => [
            'first' => 'Questa domanda non è più tra le prime. Scegline un’altra.',
            'facts' => 'Una risposta sulla sua vita non è riconosciuta.',
        ],
        'banner' => [
            'title' => 'E se le sue domande le somigliassero?',
            'body' => 'Due minuti per parlarci di :name: sceglieremo le sue domande in base alla sua vita.',
            'cta' => 'Personalizza le sue domande',
        ],
        'questions_link' => 'Personalizza in base alla sua vita',
    ],
];
