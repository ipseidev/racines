...
- [x] Étape 4 « Vos coordonnées » : création de compte Fortify inline (email, mot de passe, prénom, nom) ou connexion ; vérification d'email envoyée mais non bloquante pour payer.
