...
Les traitements sont décrits dans la politique de confidentialité. Le délégué à
la protection des données est joignable à {{ support_email }}.
...
Pour signaler un contenu, une erreur ou une personne citée dans un récit sans
son accord, écrivez à {{ support_email }}. Nous masquons par défaut en cas de
doute sérieux, le temps d'instruire la demande.
